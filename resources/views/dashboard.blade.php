                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="card prod-p-card card-red">
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('clients.index') }}">
                                        <p class="m-b-0 text-white">View More<span
                                                class="label label-danger m-r-10">CLIENTS</span></p>
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="card prod-p-card card-blue">
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('users') }}">
                                        <p class="m-b-0 text-white">View More<span
                                                class="label label-primary m-r-10">USERS</span></p>
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="card prod-p-card card-green">
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('tokens.index') }}">
                                        <p class="m-b-0 text-white">View More<span
                                                class="label label-success m-r-10">TOKENS</span></p>
                                    </a>
                                </div>
                            </div>
                        </div>
